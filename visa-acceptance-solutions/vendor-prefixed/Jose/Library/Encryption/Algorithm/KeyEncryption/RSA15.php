...
final class RSA15 extends RSA
{
     ...
     */
    private const CEK_LENGTHS = ['A128GCM' => 16, 'A192GCM' => 24, 'A256GCM' => 32, 'A128CBC-HS256' => 32, 'A192CBC-HS384' => 48, 'A256CBC-HS512' => 64];
    ...
    public function decryptKey(JWK $key, string $encrypted_cek, array $header): string
    {
        ...
        return RSACrypt::decrypt($priv, $encrypted_cek, RSACrypt::ENCRYPTION_PKCS1, null, $this->getExpectedCekLength($header));
    }
